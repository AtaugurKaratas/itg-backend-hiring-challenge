        ...
        <div class="card-body">
            <form action="add-product" method="POST"enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input name="productName" type="text" class="form-control" id="exampleInputProductName" placeholder="Ürün Adınız Giriniz" required>
                </div>
                <div class="form-group">
                    <label for="exampleInputPrice">Price</label>
                    <input name="price" type="text" class="form-control" id="exampleInputPrice" placeholder="Ürün Fiyatını Giriniz" required>
                </div>
